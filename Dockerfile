...
RUN echo 'fastfetch -l ubuntu2_old --color-keys blue' >> ~/.bashrc
RUN echo 'echo -e "\n\e[1;34mSAOV ubuntu-tools version: \e[1;32m1.0\e[1;0m"' >> ~/.bashrc
RUN echo 'echo -e "\e[1;34mSudo password: \e[1;33m<<\e[1;32mENTER\e[1;33m>>\e[1;0m"' >> ~/.bashrc
RUN echo 'echo -e "\e[1;34mCluster: \e[1;36m$Cluster\e[1;0m"' >> ~/.bashrc
